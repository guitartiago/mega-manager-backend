...
public class FecharContaClienteService implements FecharContaClienteUseCase {

    private final ClienteRepository clienteRepository;
    private final ProdutoRepository produtoRepository;
    private final ConsumoRepository consumoRepository;

    public FecharContaClienteService(ClienteRepository clienteRepository,
    ...
    @Override
    public ExtratoContaCliente fecharConta(Long clienteId) {
